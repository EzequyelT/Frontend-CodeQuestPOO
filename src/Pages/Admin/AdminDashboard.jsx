...
export default function AdminDashboard() {
  ...
  const confirmar = window.confirm(
    `Tens a certeza que queres ${acao} o aluno "${aluno.nome || "sem nome"}"?`
  );
  ...
  try {
    ...
    if (alunoSelecionado && alunoSelecionado.aluno && alunoSelecionado.aluno.id === aluno.id) {
    ...
    <main className="admin-page">
      <header className="admin-header">
        <div>
          ...
          <p>
            Gere alunos, acompanha estatísticas, consulta progresso e controla o
            ...
            <article className="admin-panel">
              ...
              {dashboard.melhorRegisto ? (
                <div className="admin-best-box">
                  ...
                  <div>
                    <strong>
                      {dashboard.melhorRegisto.aluno?.nome || "Aluno sem nome"}
                    </strong>
            ...
            <article className="admin-panel">
              ...
              <div className="admin-mini-grid">
                ...
                <div>
                  ...
                  <strong>{dashboard.conteudo?.totalAchievements || 0}</strong>
                </div>
        ...
        <section className="admin-section">
          <div className="admin-section-header">
            <div>
              ...
              <p>
                Pesquisa alunos, vê estatísticas e ativa ou desativa contas.
              </p>
            </div>
                  ...
                  alunoSelecionado.desempenhos
                    ...
                    .map((item, index) => (
                      ...
                      >
                        ...
                        <span>
                          Tempo: {formatarTempo(item.tempo_desafio)}
                        </span>
                      </div>
                    ))
                ) : (
