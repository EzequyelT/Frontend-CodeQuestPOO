...
import dsf_2 from "../../../Data/Mapa-2/Nivel-1/dsf_2"
...
const challenge = {
    nome: "Molde da Vila",
    descricao:
        "Uma classe é um modelo utilizado para criar objetos. Neste desafio vais aprender como as classes ajudam a organizar dados e comportamentos, permitindo criar vários objetos com as mesmas características de forma simples e eficiente.",
    nivel: 2,
    xp: 10,
    dificuldade: "Fácil",
};
        ...
        try {
            async function loadLevels() {
                ...
                if (data?.[0]?.desafios?.length > 0) {
                    setDesafioId(data[0].desafios[1].id)
                }
            }
    ...
    if (finished && !saving) {
        ...
        return (
            ...
            <Result
                ...
                onNextChallenge={() => {
                    navigate("/vila/nivel-5/desafio-11")
                }}
            />
        )
    }
