...
import dsf_4 from "../../../Data/Mapa-2/Nivel-2/dsf_4"
...
const challenge = {
    nome: "	Construtor Inicial",
    descricao:
        "Agora que já sabes criar classes simples, o próximo passo é aprender a utilizar o método __init__. Com ele, cada objeto pode ser criado com os seus próprios dados, tornando as classes mais úteis, flexíveis e próximas de situações reais.",
    nivel: 2,
    xp: 10,
    dificuldade: "Médio",
};
    ...
    if (finished && !saving) {
        ...
        return (
            ...
            <Result
                ...
                onNextChallenge={() => {
                    navigate("/vila/nivel-6/desafio-13")
                }}
            />
        )
    }
