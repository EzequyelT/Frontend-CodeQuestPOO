...
import dsf_5 from "../../../Data/Mapa-2/Nivel-2/dsf_5"
...
const challenge = {
    nome: "Atributos do Habitante",
    descricao:
        "Agora vais aprender a guardar informações dentro de um objeto através de atributos. Estes atributos permitem que cada objeto tenha os seus próprios dados, tornando-o único e mais realista.",
    nivel: 2,
    xp: 10,
    dificuldade: "Fácil",
};
    ...
    if (finished && !saving) {
        ...
        return (
            ...
            <Result
                ...
                onNextChallenge={() => {
                    navigate("/vila/nivel-6/desafio-14")
                }}
            />
        )
    }
