...
import Bg from "../../../../assets/Maps/Bg-Map2-Nivel3.png"
import dsf_7 from "../../../Data/Mapa-2/Nivel-3/dsf_7"
...
const challenge = {
    nome: "Métodos da Oficina",
    descricao:
        "Agora vais criar métodos dentro das classes para que os objetos consigam executar ações.  Ou seja, além de guardarem dados, os objetos também vão fazer coisas, Nesta fase vais aprender a definir métodos e a chamá-los através dos objetos",
    nivel: 2,
    xp: 10,
    dificuldade: "Fácil",
};
    ...
    if (finished && !saving) {
        ...
        return (
            ...
            <Result
                ...
                onNextChallenge={() => {
                    navigate("/vila/nivel-7/desafio-16")
                }}
            />
        )
    }
